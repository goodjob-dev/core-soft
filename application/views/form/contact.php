				...
				<form method="post" action="">
					...
					<div class="row">
						<div class="col-lg-6 input-group-contact">
							...
							<input type="text" name="url" id="url" class="form-input" value="<?php echo set_value('url'); ?>">
							<?php echo form_error('url', '<div class="error">', '</div>'); ?>
						</div>
						<div class="col-lg-6 input-group-contact">
							<label for="phone">Phone (optional)</label>
							<input type="text" name="phone" id="phone" class="form-input" value="<?php echo set_value('phone'); ?>">
						</div>
					</div>


					<div class="row">
						<div class="col-lg-12 input-group-contact">
							<label for="message-text">Message (required)</label>
